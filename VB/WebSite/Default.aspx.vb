...
'INSTANT VB NOTE: The variable header was renamed since Visual Basic does not handle local variables named the same as class members well:
			Dim header_Conflict As New LinkBase()
			AddHandler header_Conflict.CreateDetailHeaderArea, AddressOf Header_CreateDetailHeaderArea
			...
			compositeLink.Links.AddRange(New Object() { header_Conflict, link1 })
